...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.readerService.getReaderByService('Checkout').subscribe({
  ...
  onCheckIn() {
    ...
    if (employee === '') {
      ...
      this.workorderService.ItemCheckout(this.formGroup.value).subscribe({
        //next: (r) => ,
        error: (e) => {
          this.messageService.add({ severity: 'error', detail: e });
          this.loading = false;
        ...
        complete: () => {
          ...
          this.messageService.add({
            severity: 'info',
            detail: 'Items successfully checkout',
          });
          this.onClearItems();
          this.formGroup.patchValue({
            Employeeid: employee,
